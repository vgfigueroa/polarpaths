document.getElementById("Submit").addEventListener("click", function (e) {
    ...
    // Display email instructions below the form
    const emailInstructions = document.getElementById("emailInstructions");
    emailInstructions.textContent = `Email your file to polarpaths@bowdoin.edu with subject line "Suggestion ${formattedDate}"`;
  });
